...
RUN wget https://download.jetbrains.com/resharper/JetBrains.Rider-2017.2.tar.gz -O JetBrains.Rider-2017.2.tar.gz
RUN tar xfz JetBrains.Rider-2017.2.tar.gz -C /opt
...
# start vscode
ENTRYPOINT ["/developer/bin/start-rider"]
